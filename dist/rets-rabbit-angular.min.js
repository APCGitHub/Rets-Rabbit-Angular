...
!function(){"use strict";function e(e,t){function n(n){var c=n.config.config||{};if(!c.ignoreAuth&&401==n.status&&o>r){r++;var i=e.get("RRAuthFactory"),u=e.get("$http"),s=t.defer();return i.getToken().then(function(e){s.resolve(e)},function(e){s.reject(e)}),s.promise.then(function(){return console.log("we did get top"),u(n.config)},function(){console.log("we did get here")})}return r=0,t.reject(n)}var r=0,o=5,c={responseError:n};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",e),e.$inject=["$injector","$q"]}();
