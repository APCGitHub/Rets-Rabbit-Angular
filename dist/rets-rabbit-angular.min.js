...
!function(){"use strict";function r(r,e){function t(t){if(401==t.status){console.log("Had a 401 error");var n=r.get("RRAuthFactory"),o=r.get("$http"),c=e.defer();return n.getToken().then(c.resolve,c.reject),c.promise.then(function(){return o(t.config)})}return e.reject(t)}var n={responseError:t};return n}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptor",r),r.$inject=["$injector","$q"]}();
