...
!function(){"use strict";function e(e,r,t,o){function a(a,n){var c=r.defer();return e.get(o.apiUrl+"property/"+a,{params:n,headers:{Authorization:"Bearer "+t.localStorage.getItem("token")}}).success(function(e){var r=e.value;c.resolve(r)}).error(function(e){console.log(e),c.reject(e)}),c.promise}function n(){var a=r.defer();return e.get(o.apiUrl+"property/$metadata",{headers:{Authorization:"Bearer "+t.localStorage.getItem("token")}}).success(function(e){a.resolve(e)}).error(function(e){a.reject(e)}),a.promise}function c(a){var n=r.defer();encodeURIComponent(a);return e.get(o.apiUrl+"property?"+a,{headers:{Accept:"odata.metadata=full",Authorization:"Bearer "+t.localStorage.getItem("token")}}).success(function(e){n.resolve(e)}).error(function(e){n.reject(e)}),n.promise}var i={findOne:a,metadata:n,search:c};return i}angular.module("rets-rabbit-angular.factory.properties",[]).factory("PropertyFactory",e),e.$inject=["$http","$q","$window","ApiConfig"]}();
...
!function(){"use strict";function t(t,r){function e(e){var c=e.config.config||{};if(!c.ignoreAuth&&401==e.status&&o>n){n++;var i=t.get("RRAuthFactory"),u=t.get("$http"),s=r.defer();return i.getToken().then(function(t){s.resolve(t)},function(t){s.reject(t)}),s.promise.then(function(){return u(e.config)})}return n=0,r.reject(e)}var n=0,o=5,c={responseError:e};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",t),t.$inject=["$injector","$q"]}();
