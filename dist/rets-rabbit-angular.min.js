...
!function(){"use strict";function e(e,r,t,o){function a(a,n){var i=e.defer();return r.get(t.v1.apiUrl+a+"/listing/search?"+n,{headers:{Authorization:"Bearer "+o.v1.getToken()}}).success(function(e){i.resolve(e)}).error(function(e){i.reject(e)}),i.promise}function n(a){var n=e.defer();return r.get(t.v1.apiUrl+a+"/metadata/explorer",{headers:{Authorization:"Bearer "+o.v1.getToken()}}).success(function(e){n.resolve(e)}).error(function(e){n.reject(e)}),n.promise}var i={search:a,metadata:n};return i}angular.module("rets-rabbit-angular.factory.properties.v1",[]).factory("PropertyFactoryV1",e),e.$inject=["$q","$http","ApiConfig","KeyStorageService"]}();
