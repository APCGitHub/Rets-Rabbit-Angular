...
!function(){"use strict";function t(t,r){function e(e){var c=e.config.config||{};if(!c.ignoreAuth&&401==e.status&&o>n){n++;var i=t.get("RRAuthFactory"),u=t.get("$http"),a=r.defer();return i.getToken().then(function(t){a.resolve()},function(t){a.reject(t)}),a.promise.then(function(){return u(e.config)})}return n=0,r.reject(e.data)}var n=0,o=5,c={responseError:e};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",t),t.$inject=["$injector","$q"]}();
