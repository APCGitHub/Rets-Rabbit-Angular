...
!function(){"use strict";function e(e,r){function t(t){if(console.log(t),401==t.status){console.log("Had a 401 error");var o=e.get("RRAuthFactory"),n=e.get("$http"),c=r.defer();return o.getToken().then(c.resolve,c.reject),c.promise.then(function(){return n(t.config)})}return r.reject(t)}console.log("this is the interceptor factory...");var o={responseError:t};return o}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",e),e.$inject=["$injector","$q"]}();
