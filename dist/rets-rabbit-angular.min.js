...
!function(){"use strict";function e(e,t,n,o){function c(){var c=t.defer();return e({method:"POST",url:o.baseUrl+"api/oauth/access_token",data:{client_id:o.clientId,client_secret:o.clientSecret,grant_type:"client_credentials"}}).success(function(e){n.localStorage.setItem("token",e.access_token),console.log(n.localStorage.getItem("token")),c.resolve(e)}).error(function(e){console.log("THERE IS THE ERROR BLOCK"),c.reject(e)}),c.promise}var r={getToken:c};return r}angular.module("rets-rabbit-angular.factory.auth",[]).factory("RRAuthFactory",e),e.$inject=["$http","$q","$window","ApiConfig"]}();
...
!function(){"use strict";function e(e,r){function t(t){if(console.log("the method"),401==t.status){console.log("increasing error count"),o++;var c=e.get("RRAuthFactory"),s=e.get("$http"),u=r.defer();return c.getToken().then(u.resolve,u.reject),o>=n?(console.log("error_count was too great"),o=0,r.reject(t)):u.promise.then(function(){return o=0,s(t.config)})}return r.reject(t)}console.log("constructor");var o=0,n=5,c={responseError:t};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",e),e.$inject=["$injector","$q"]}();
