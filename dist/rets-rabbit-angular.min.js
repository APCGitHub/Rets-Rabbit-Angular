...
!function(){"use strict";function e(e,t,n,r){function c(){var c=t.defer();return e({method:"POST",url:r.baseUrl+"api/oauth/access_token",data:{client_id:r.clientId,client_secret:r.clientSecret,grant_type:"client_credentials"}}).success(function(e){n.localStorage.setItem("token",e.access_token),console.log(n.localStorage.getItem("token")),c.resolve(e)}).error(function(e){c.reject(e)}),c.promise}var o={getToken:c};return o}angular.module("rets-rabbit-angular.factory.auth",[]).factory("RRAuthFactory",e),e.$inject=["$http","$q","$window","ApiConfig"]}();
