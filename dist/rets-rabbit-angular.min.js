...
!function(){"use strict";function t(t,e){function r(r){if(401==r.status){var c=t.get("RRAuthFactory"),i=t.get("$http"),s=e.defer();return c.getToken().then(s.resolve,s.reject),n>=o?(n=0,s.promise):s.promise.then(function(){return n=0,i(r.config)},function(){n++})}return e.reject(r)}console.log("this is the interceptor factory...");var n=0,o=5,c={responseError:r};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",t),t.$inject=["$injector","$q"]}();
