...
!function(){"use strict";function r(r,e){function t(t){if(401==t.status){var c=r.get("RRAuthFactory"),s=r.get("$http"),i=e.defer();return c.getToken().then(i.resolve,i.reject),o>=n?(console.log("error_count was too great"),o=0,i.promise):i.promise.then(function(){return o=0,s(t.config)},function(){console.log("increasing error count"),o++})}return e.reject(t)}var o=0,n=5,c={responseError:t};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",r),r.$inject=["$injector","$q"]}();
