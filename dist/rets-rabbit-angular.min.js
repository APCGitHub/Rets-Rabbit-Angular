...
!function(){"use strict";function e(e,n,t,r){function o(){var o=n.defer();return e({method:"POST",url:t.v1.baseUrl+"api/oauth/access_token",config:{ignoreAuth:!0,version:1},data:i({client_id:t.v1.clientId,client_secret:t.v1.clientSecret,grant_type:"client_credentials"}),headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(e){r.v1.saveToken(e.access_token),o.resolve(e)}).error(function(e){o.reject(e)}),o.promise}function c(){var o=n.defer();return e({method:"POST",url:t.v2.baseUrl+"api/oauth/access_token",config:{ignoreAuth:!0,version:2},headers:{"Content-Type":"application/x-www-form-urlencoded"},data:i({client_id:t.v2.clientId,client_secret:t.v2.clientSecret,grant_type:"client_credentials"})}).success(function(e){r.v2.saveToken(e.access_token),o.resolve(e)}).error(function(e){o.reject(e)}),o.promise}function i(e){var n=[];for(var t in e)e.hasOwnProperty(t)&&n.push(encodeURIComponent(t)+"="+encodeURIComponent(e[t]));return n.join("&")}var a={getTokenV1:o,getTokenV2:c};return a}angular.module("rets-rabbit-angular.factory.auth",[]).factory("RRAuthFactory",e),e.$inject=["$http","$q","ApiConfig","KeyStorageService"]}();
