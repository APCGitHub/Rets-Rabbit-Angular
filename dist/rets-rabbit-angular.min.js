...
!function(){"use strict";function r(r,t){function e(e){var c=e.config||{};if(console.log(!c.ignoreAuth),!c.ignoreAuth&&401==e.status&&o>n){n++;var i=r.get("RRAuthFactory"),u=r.get("$http"),s=t.defer();return i.getToken().then(s.resolve,s.reject),s.promise.then(function(){return u(e.config)})}return n=0,t.reject(e)}var n=0,o=5,c={responseError:e};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",r),r.$inject=["$injector","$q"]}();
