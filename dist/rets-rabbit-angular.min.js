...
!function(){"use strict";function t(t,r){function e(e){var c=e.config.config||{};if(!c.ignoreAuth&&401==e.status&&o>n){n++;var i=t.get("RRAuthFactory"),u=t.get("$http"),f=r.defer();return i.getToken().then(function(t){f.resolve(t)},function(t){f.reject(t)}),f.promise.then(function(){return u(e.config)},function(t){return r.reject(e)})}return n=0,r.reject(e)}var n=0,o=5,c={responseError:e};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",t),t.$inject=["$injector","$q"]}();
