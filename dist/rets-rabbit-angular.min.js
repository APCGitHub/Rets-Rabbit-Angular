...
!function(){"use strict";function e(e,r){function t(t){if(console.log("the method"),401==t.status&&n>o){console.log("increasing error count"),o++;var c=e.get("RRAuthFactory"),s=e.get("$http"),i=r.defer();return c.getToken().then(i.resolve,i.reject),i.promise.then(function(){return s(t.config)})}return o=0,r.reject(t)}console.log("constructor");var o=0,n=5,c={responseError:t};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",e),e.$inject=["$injector","$q"]}();
