...
!function(){"use strict";function t(t,r){function e(e){if(401==e.status&&o>n){n++;var c=t.get("RRAuthFactory"),i=t.get("$http"),s=r.defer();return c.getToken().then(s.resolve,s.reject),s.promise.then(function(){return i(e.config)})}return n=0,r.reject(e)}var n=0,o=5,c={responseError:e};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",t),t.$inject=["$injector","$q"]}();
