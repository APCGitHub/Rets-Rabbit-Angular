...
!function(){"use strict";function r(r,e){function o(o){if(console.log("the method"),401==o.status){var c=r.get("RRAuthFactory"),s=r.get("$http"),i=e.defer();return c.getToken().then(i.resolve,i.reject),t>=n?(console.log("error_count was too great"),t=0,i.promise):i.promise.then(function(){return t=0,s(o.config)},function(){console.log("increasing error count"),t++})}return e.reject(o)}console.log("constructor");var t=0,n=5,c={responseError:o};return c}angular.module("rets-rabbit-angular.factory.session.interceptor",[]).factory("SessionInterceptorFactory",r),r.$inject=["$injector","$q"]}();
